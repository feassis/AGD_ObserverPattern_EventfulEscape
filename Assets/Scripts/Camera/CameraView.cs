...
public class CameraView : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        EventService.Instance.OnSkullShower.AddListener(Shake);
        EventService.Instance.OnPaintingChangeEvent.AddListener(Shake);
    }
    ...
    private void OnDisable()
    {
        ...
        EventService.Instance.OnSkullShower.RemoveListener(Shake);
        EventService.Instance.OnPaintingChangeEvent.RemoveListener(Shake);
    }
